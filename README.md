# Cat-logo-de-Cursos
# Catálogo de Cursos – Proyecto de Plataformas de Colaboración Digital
...
## Funcionalidades
- Muestra una lista de **3–5 cursos estáticos** con nombre, área y ID.  
- Permite **filtrar cursos por texto** mediante un campo de búsqueda.  
- Interfaz visual limpia con color institucional **#0099A8**.  
